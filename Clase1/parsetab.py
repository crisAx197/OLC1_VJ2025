...
_lr_productions = [
  ...
  ('instruccion -> REVALUAR CORIZQ expresion CORDER PTCOMA','instruccion',5,'p_instrucciones_evaluar','gramatica.py',77),
  ('expresion -> expresion MAS expresion','expresion',3,'p_expresion_binaria','gramatica.py',81),
  ('expresion -> expresion MENOS expresion','expresion',3,'p_expresion_binaria','gramatica.py',82),
  ('expresion -> expresion POR expresion','expresion',3,'p_expresion_binaria','gramatica.py',83),
  ('expresion -> expresion DIVIDIDO expresion','expresion',3,'p_expresion_binaria','gramatica.py',84),
  ('expresion -> MENOS expresion','expresion',2,'p_expresion_unaria','gramatica.py',92),
  ('expresion -> PARIZQ expresion PARDER','expresion',3,'p_expresion_agrupacion','gramatica.py',96),
  ('expresion -> ENTERO','expresion',1,'p_expresion_number','gramatica.py',100),
  ('expresion -> DECIMAL','expresion',1,'p_expresion_number','gramatica.py',101),
]
